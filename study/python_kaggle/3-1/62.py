...
plt.legend(handles=[plt1, plt4])
plt.show()
# 输出线性回归模型在训练样本上的R-squared值
print ('The R-squared value of Liner Regressor(Degree=2) performing on training data is', regressor_poly4.score(X_train_poly4, y_train))
