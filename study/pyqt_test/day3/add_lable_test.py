#-*- coding:utf-8 -*-
"""
 Createed by xlj on 2018/7/26
"""
import sys

from PyQt5.QtWidgets import QMainWindow, QAction, QLabel, QApplication
...
class GUI(QMainWindow):
    ...
    def add_position_layout(self):
        ...
        # 第一个标签
        lable=QLabel('第一个标签',self)
        lable.move(10,mbar_height)
        # 第二个标签
        lable_2=QLabel('第二个标签',self)
        lable_2.move(10,mbar_height*2)
